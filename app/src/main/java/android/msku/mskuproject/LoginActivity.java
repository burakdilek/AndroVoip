...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView mEmailView, mDomainView, mProxyView, mPortView;
    ...
    private void attemptLogin() {
        ...
        String proxy = mProxyView.getText().toString();
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, domain, port, proxy);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, String domain, String port, String proxy) {
            mEmail = email;
            mPassword = password;
            mDomain = domain;
            mPort = port;
